...
// UserSecretsSummary contains deployment-wide aggregates about
// user secrets. UsersWithSecrets and TotalSecrets are total counts.
// EnvNameOnly, FilePathOnly, Both, and Neither break TotalSecrets
